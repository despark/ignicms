...
<script type="text/javascript">
    ...
    tinymce.init({
        ...
        menubar: false,
        toolbar: "undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist | link image jbimages | media",
        image_advtab: true,
        relative_urls: false,
        ...
        style_formats: [
            ...
            {title: 'Smaller image - right', selector: 'img', classes: 'image-in-content image-smaller-right'},
            {
                ...
                {
                    title: 'Right aligned article',
                    block: 'article',
                    classes: 'text-container-right',
                    wrapper: true,
                    merge_siblings: false
                },
                {
                    title: 'Center aligned article',
                    block: 'article',
