...
tinymce.PluginManager.add('twittersharelink', function(editor) {
    var attachState = {};
    ...
    function showDialog(linkList) {
        ...
        data.href = decodeURIComponent(data.href.replace('https://twitter.com/intent/tweet?text=', ''));
        ...
        win = editor.windowManager.open({
            ...
            onSubmit: function(e) {
                ...
                function createLink() {
                    var linkAttrs = {
                        href: "https://twitter.com/intent/tweet?text=" + encodeURI(href),
                        target: '_blank',
                        rel: 'nofollow',
    ...
    editor.addButton('twittersharelink', {
        icon: 'link',
        text: 'Twitter link',
        shortcut: 'Meta+K',
        onclick: createLinkList(showDialog),
        stateSelector: 'a[href].twitter-share-link'
    });

    this.showDialog = showDialog;

    editor.addMenuItem('twittersharelink', {
        icon: 'link',
        text: 'Link',
        shortcut: 'Meta+K',
        onclick: createLinkList(showDialog),
